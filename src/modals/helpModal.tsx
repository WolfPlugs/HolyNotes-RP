      ...
      <ModalContent>
        <div className="help-markdown">
          ...
          <FormText.DESCRIPTION>
            To add a note right click on a message then hover over the "Note Message" item and click<br />
            the button with the notebook name you would like to note the message to.<br />
          

          <span style={{ fontWeight: 'bold' }} className={colorStatusGreen}>Protip:</span> Clicking the "Note Message" button by itself will note to Main by default!
          </FormText.DESCRIPTION><hr />
