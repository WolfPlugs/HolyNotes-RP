      ...
      <ModalContent>
        <Slider fade={true}>
          <div className="help-markdown">
            <h4>Adding Notes</h4>
            <p>
              To add a note right click on a message then hover over the "Note Message" item and
              click the button with the notebook name you would like to note the message to.
            </p>
            <br />
            <p>
            ...
            <p>
              To jump to the location that the note was originally located at just right click on
