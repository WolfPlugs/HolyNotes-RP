  ...
  <div className={classes.emptyResultsWrap}>
    <div className={classes.emptyResultContent} style={{ paddingBottom: "0px" }}>
      ...
      <div className={classes.emptyResultstext}>
        There was an error parsing your notes! The issue was logged in your console, press CTRL + I
        to access it! Please visit the support server if you need extra help!
      </div>
    </div>
  </div>
);
...
const NotebookEmpty = () => (
  <div className={classes.emptyResultsWrap}>
    <div className={classes.emptyResultsContent} style={{ paddingBottom: "0px" }}>
      ...
      <div className={classes.emptyResultsText}>No notes were found saved in this notebook.</div>
    </div>
  </div>
);
